...
- [**平台使用指南**](/docs/guide/mcp-tutorials/mcp-usage-guide/mcp-platform-usage) - 在不同平台上设置和使用MCP的详细教程
...
export function RelatedLinks() {
  return (
    <div className="related-links">
      <h4>延伸阅读</h4>
      <ul>
        <li><a href="/docs/guide/mcp-tutorials/mcp-introduction">MCP介绍</a></li>
        <li><a href="/docs/guide/mcp-tutorials/mcp-server-ecosystem">MCP服务器生态系统</a></li>
        <li><a href="/docs/guide/mcp-tutorials/mcp-usage-guide/mcp-platform-usage">MCP平台使用指南</a></li>
