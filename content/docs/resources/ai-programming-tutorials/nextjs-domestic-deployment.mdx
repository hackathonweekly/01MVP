...
参考： [创建你的第一个 Devbox](https://fael3z0zfze.feishu.cn/wiki/RIK1wtJh2i6muckqggkcmxxVn0b)

里头的这个案例不错： [不会前端也能写官网？没问题，Devbox+Cursor 带你起飞](https://fael3z0zfze.feishu.cn/wiki/MzTxwors0iRoJ3kR3oQc2t6EnQO)


https://gitee.com/jackiegeek/jackiexiao.com
...
./
![](/images/nextjs-domestic-deployment.001.png)
...
创建项目后，你./中找到它。每个项目都有一个操作列，可以在操作列的下拉框中切换不同的 IDE。

![](/images/nextjs-domestic-deployment.002.png)
...
![](/images/nextjs-domestic-deployment.003.png)
...
./
![](/images/nextjs-domestic-deployment.004.png)
